...
print("Total value of all loans in the list is:", total_of_all_loans)
...
print("The loan cost is:", cost)
if present_value >= cost:
    print("The loan is worth at least a cost to buy it!")
else:
...
# YOUR CODE HERE!
present_value = present_value_calculator(new_loan["future_value"], new_loan["remaining_months"], 0.2)
...
output_path = Path("list_of_inexpensive_loans.csv")
...
csvpath = Path("list_of_inexpensive_loans.csv")
